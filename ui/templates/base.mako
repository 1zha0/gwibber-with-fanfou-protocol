...
<%def name="buttons(data)">
  <div class="replybutton">
    <a href="gwibber:menu/${data.message_index}"><img width="16px" src="${resources.icon('system-run')}" /></a> 
    <a href="gwibber:reply/${data.message_index}"><img width="16px" src="${resources.icon('mail-reply-sender')}" /></a>
  </div>
</%def>
